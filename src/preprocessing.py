...
class Example(object):
  ...
  def __init__(self, article, abstract_sentences, vocab):
    ...
    if len(article_words) > cfg.ENCODER_MAX_STEPS:
      article_words = article_words[:cfg.ENCODER_MAX_STEPS]
    ...
    self.dec_input, self.target = self.get_dec_inp_targ_seqs(abs_ids, cfg.DECODER_MAX_STEPS, start_decoding, stop_decoding)
    ...
    _, self.target = self.get_dec_inp_targ_seqs(abs_ids_extend_vocab, cfg.DECODER_MAX_STEPS, start_decoding, stop_decoding)
